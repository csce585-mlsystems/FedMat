...
class SchNet(torch.nn.Module):
    ...
    def forward(self, z, pos, batch=None):
        ...
        # Capture per-atom embeddings
        h_per_atom = h  # Shape: [number_of_atoms, hidden_channels]

        # Aggregate to per-molecule embeddings
        h_mol = scatter(
            h_per_atom, batch, dim=0, reduce="mean"
        ...
        # print(out.shape)
        # print(h_mol.shape, "zzzzzzzzzzzzz")
        return out, h_mol
